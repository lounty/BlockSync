 ...
 * This file demonstrates how to integrate Blocksync with a web frontend
 */

// For React/Vue/Angular applications
export class BlocksyncClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BlocksyncClient(provider, contractAddress);
